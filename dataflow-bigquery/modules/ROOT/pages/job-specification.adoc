...
- `query_temp_project` (string, optional) Specifies the project to use for temporary data processing by Apache Beam. If not set, Apache
 Beam will use the current project.
- `query_temp_dataset` (string, optional) Specifies the dataset to use for temporary data processing by Apache Beam. If not set, Apache Beam will create its own datasets for processing.
