...
The worker service account gets its Dataflow, bucket, and job-creation roles in the runner project, exactly as in the <<single-project,single-project example>>:
