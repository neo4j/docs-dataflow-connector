...
== Release 2026-02-17-00_RC00

* Upgrade import-spec from 1.0.0-rc03 to 1.0.0-rc11
This allows users to define mapping overrides for the key properties of start and end nodes
