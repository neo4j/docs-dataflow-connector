...
The file can either be uploaded as a secret with Google Cloud Secret Manager or uploaded directly to Google Cloud Storage.
// end::neo4j[]
...
You need access to link:https://console.cloud.google.com/security/secret-manager[Google Secret Manager].

Go ahead and create the secret with a unique name and upload `neo4j-connection-info.json` for the secret's value.
// end::secret[]
