...
*Aura*::
Use the connection URI (`neo4j+s://…`).

*Self-managed*::
Use an address reachable from Dataflow workers.
====
...
Although Dataflow jobs can run on **Neo4j Community Edition instances, this is not officially supported**.
